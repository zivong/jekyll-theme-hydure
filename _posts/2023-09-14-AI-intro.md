...
![](https://github.com/rkuo2000/AI-course/blob/main/images/ChatGPT_turing_test.png?raw=true)
...
* [2023/10/19 救生員的第二雙眼睛! 德國泳池引進「AI水下監控」提升安全性](https://youtu.be/dFo7HFdOXIQ?si=JCDWbyPZbDO8zodA)  
...
![](https://en.wikipedia.org/wiki/File:Astronaut_Riding_a_Horse_(SDXL).jpg)

#### Text-to-Song
**[Riffusion](https://www.riffusion.com/)**<br>
<audio id="mwe_player_0_html5_api" preload="metadata" class="vjs-tech" style="width:220px;" data-durationhint="16" data-mwtitle="AI-generated_audio_featuring_bossa_nova_music_with_electric_guitar.ogg" data-mwprovider="wikimediacommons" resource="/wiki/File:AI-generated_audio_featuring_bossa_nova_music_with_electric_guitar.ogg" playsinline="playsinline" tabindex="-1" role="application" src="//upload.wikimedia.org/wikipedia/commons/transcoded/0/0a/AI-generated_audio_featuring_bossa_nova_music_with_electric_guitar.ogg/AI-generated_audio_featuring_bossa_nova_music_with_electric_guitar.ogg.mp3"><source src="//upload.wikimedia.org/wikipedia/commons/transcoded/0/0a/AI-generated_audio_featuring_bossa_nova_music_with_electric_guitar.ogg/AI-generated_audio_featuring_bossa_nova_music_with_electric_guitar.ogg.mp3" type="audio/mpeg" data-transcodekey="mp3" data-width="0" data-height="0"><source src="//upload.wikimedia.org/wikipedia/commons/0/0a/AI-generated_audio_featuring_bossa_nova_music_with_electric_guitar.ogg" type="audio/ogg; codecs=&quot;vorbis&quot;" data-width="0" data-height="0"></audio>

#### Text-to-Video
**[Runway Gen2](https://research.runwayml.com/gen2)**<br>
![](https://en.wikipedia.org/wiki/File:Gen2-Example-Dog-Podium.webm)
...
---
### AI & Robotics
1. Autonomous Driving (自動駕駛)

2. Military Drones (軍用無人機)
