...
AI in Games, Multi-Agent RL, Imitation Learning , Meta Learning, Robot Navigation, Embodied AI.
...
![](https://miro.medium.com/max/900/1*cOu3CIFS1zw2qXkuuHy7lA.png)
![](https://miro.medium.com/max/2000/1*JuRvWsTyaRWZaYVirSsWiA.png)
![](https://miro.medium.com/max/2000/1*GMGAfQeLvxJnTRQOEuTMDw.png)
...
![](https://cdn-media-1.freecodecamp.org/images/1*Zplt-1wTWu_7BGmZCBFjbQ.png)
...
**more examples:** [RL-Gym/SB3](https://github.com/rkuo2000/RL-Gym/tree/main/SB3)
* cartpole_a2c.py
* cartpole_dqn.py
* cartpole_ppo.py
...
**OpenAI Gym**: [dqn.py](https://github.com/rkuo2000/RL-Gym/blob/main/cartpole/dqn.py)<br>
```
class DQNAgent:
...
**Code:** [MadMario](https://github.com/rkuo2000/MadMario)<br>
`pip install gym-super-mario-bros`<br>
`git clone https://github.com/rkuo2000/MadMario`<br>

Training time is around 80 hours on CPU and 20 hours on GPU.<br>
To train  : (epochs=40000)<br>
`python main.py`<br>

To replay : (modify checkpoint path)<br>
`python replay.py`<br>
...
![](https://github.com/rkuo2000/AI-course/blob/gh-pages/images/pendulum_ddpg.png?raw=true)
...
**Code:** [ppo_cartpole](https://keras.io/examples/rl/ppo_cartpole/)<br>
**Blog:** [Proximal Policy Optimization](https://intellabs.github.io/coach/components/agents/policy_optimization/ppo.html)<br>
...
![](https://github.com/rkuo2000/AI-course/blob/gh-pages/images/cartpole_ppo.png?raw=true)
...
---
## MARL 
MARL (Multi-Agent Reinforcement Learning) 的主題思想是協作或競爭
