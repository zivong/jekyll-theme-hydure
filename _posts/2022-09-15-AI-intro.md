...
Introduction to AI: Influences, Applications, Future, Evolution, Key researchers, Competitions.
...
- 即便是「強化學習」（Reinforcement learning）也遠遠不夠，楊立昆拿 DeepMind 底下的專案 AlphaGo 舉例道，儘管這些模型是下棋高手，但他們仍只是專注在執行「動作」的程式。<br>
...
* **Question 1.**<br>
Given a Robot price tag at $100K USD, what is the target market that Elon Musk see for Tesla Optimus ?

* **Question 2.**<br>
Given its dexterity, What are the enhanced features (extra arm, replaceable gripper, ... ) for a specific application (healthcare, military, miner, ...) ?
