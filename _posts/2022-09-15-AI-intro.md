...
* [Midjourney AI-Generated Art Wins Colorado State Fair Prize](https://voicebot.ai/2022/09/05/midjourney-ai-generated-art-wins-colorado-state-fair-prize/)
* [AI機器人ChatGPT爆紅　專家點出重大影響](https://www.digitimes.com.tw/iot/article.asp?id=0000652798_E7C62PT4L9WAVR7E2V4LY)<br>

---
## AI 的未來

### Levels of AGI
**Paper:** [https://arxiv.org/abs/2311.02462](https://arxiv.org/abs/2311.02462)<br>
DeepMind 對 AGI 的現有定義進行了分析，並提煉出了六個原則：<br>
* 關注模型能力，而不是過程。
* 注注通用性和效能。
* 關注認知和元認知任務。
* 關注潛能，而不是部署。
...
在這些原則的基礎之上， DeepMind 從效能和通用性兩個維度提出了「AGI 等級（Levels of AGI）」<br>
